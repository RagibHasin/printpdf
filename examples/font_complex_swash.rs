...
fn main() {
    ...
    current_layer.write_complex_text(text, &font, Bengali, LeftToRight);
    current_layer.add_line_break();
    current_layer.write_complex_text(text2, &font, Bengali, LeftToRight);
    current_layer.add_line_break();
    ...
    doc.save(&mut BufWriter::new(
        File::create("test_fonts_complex_swash.pdf").unwrap(),
    ))
    .unwrap();
}
